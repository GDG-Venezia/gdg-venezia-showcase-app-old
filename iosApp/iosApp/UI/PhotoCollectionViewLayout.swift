...
//
//  https://github.com/heuristisk/hkAlium/blob/master/hkAlium/UICustomCollectionViewLayout.swift
//
...
public class PhotoCollectionViewLayout: UICollectionViewLayout {
